...
Yet when considering purpose built cities, should we only consider built ones? Can we expand our definition of ‘city’? Looking at the origin of the word: [“from Old French cite, from Latin civitas, from civis ‘citizen’”](https://www.lexico.com/definition/city)(Oxford). Does a citizen have to only be human? How about a termite mound? Does it have citizens, a video game, or cellular automata?
